// ClassifyRelations.js
import React, { useState } from 'react';
import Matrix from './Matrix';
import { useNavigate } from 'react-router-dom';

const ClassifyRelations = () => {
    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', backgroundColor: '#f0f0f0', minHeight: '100vh' }}>
            ...
            <h1 style={{ textAlign: 'center', marginBottom: '30px', color: '#333' }}>Классификация бинарных отношений</h1>
...
export default ClassifyRelations;